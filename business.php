...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="business.php" style="color:#333b77;font-family:'sans-serif',Cairo;padding-bottom: 16px;font-size: 17px;font-weight: 400;">أعمال</a>
  </li>
  <li class="nav-item">
    ...
    <div class="col-lg">
          ...
          <div id="latest-news" style="padding: 10px;">
            <div style="background: #edf0f6;border-right: 10px solid #ca0606;max-height: 45px;height: 45px;">
              <a href="latest-article.php"><h3 style="color:#333b77;font-family: 'sans-serif', Cairo;font-size: 25px;padding: 7px;font-weight: 700;">أعمال</h3></a>
            </div>
            <br>
            <div class="container" style="max-width: 100%;">
              <div class="row">
<?php
$sql = "SELECT * FROM articles WHERE section = 'اعمال' ORDER BY id DESC LIMIT 21";
