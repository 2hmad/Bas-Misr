...
<html lang="ar">
    <head>
    <title>اخر الاخبار - حيث الاخبار لا تنتهي</title>
...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="latest-article.php" style="color:#333b77;font-family:'sans-serif',Cairo;padding-bottom: 16px;font-size: 17px;font-weight: 400;">اخر الاخبار</a>
  </li>
  <li class="nav-item">
    ...
    <div class="col-lg">
          ...
          <div id="latest-news" style="padding: 10px;">
            ...
            <div class="container" style="max-width: 100%;">
              <div class="row">
<?php
$sql = "SELECT * FROM articles ORDER BY id DESC LIMIT 21";
