...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" href="home.php" style="color:#333b77;font-family:'sans-serif',Cairo;padding-bottom: 16px;font-size: 17px;font-weight: 400;">الرئيسية</a>
  </li>
  <li class="nav-item">
    ...
    <div class="col-lg">
          ...
          <div id="latest-news" style="padding: 10px;">
            <div style="background: #edf0f6;border-right: 10px solid #ca0606;max-height: 45px;height: 45px;">
              <a href="latest-article.php"><h3 style="color:#333b77;font-family: 'sans-serif', Cairo;font-size: 25px;padding: 7px;font-weight: 700;">اخر الاخبار</h3></a>
            </div>
            <br>
            <div class="container" style="max-width: 100%;">
              <div class="row">
<?php
$sql = "SELECT * FROM articles ORDER BY id DESC LIMIT 12";
...
?>
  ...
  <a href="latest-article.php">
    ...
    margin-left: auto;
    margin-right: auto;
    display: block;">رؤية المزيد</button>
  </a>
  <br>
  <div id="trending-news" style="padding: 10px;border-bottom: 1px solid #e0e0e0;">
            <div style="background: #edf0f6;border-right: 10px solid #ca0606;max-height: 45px;height: 45px;">
              <a href="latest-article.php"><h3 style="color:#333b77;font-family: 'sans-serif', Cairo;font-size: 25px;padding: 7px;font-weight: 700;">الاكثر تداولاً</h3></a>
            </div>
            <br>
            <div class="container" style="max-width: 100%;">
              <div class="row">
<?php
$sql = "SELECT * FROM articles ORDER BY views DESC LIMIT 6";
$query = mysqli_query($connect, $sql);
while($row = mysqli_fetch_array($query)){
  $id = $row['id'];
  $cover = $row['cover'];
